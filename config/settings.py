...
print("DEBUG ENV CHECK:", {
    "ACCESS_KEY_ID": bool(AWS_ACCESS_KEY_ID),
    "SECRET_ACCESS_KEY": bool(AWS_SECRET_ACCESS_KEY),
    "BUCKET_NAME": bool(AWS_STORAGE_BUCKET_NAME),
    "ENDPOINT_URL": bool(AWS_S3_ENDPOINT_URL),
})